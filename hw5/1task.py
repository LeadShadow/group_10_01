...
# Ряд Фибоначчи — это последовательность чисел вида: 0, 1, 1, 2, 3, 5, 8, ... где каждое следующее число последовательности
# получается сложением двух предыдущих членов ряда.

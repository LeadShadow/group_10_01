...
#
# Создайте функцию get_random_winners(quantity, participants), которая будет возвращать список
# уникальных идентификаторов базы данных из словаря participants количеством quantity.
...
def get_random_winners(quantity, participants):
    ...
    return participants_keys[:quantity]

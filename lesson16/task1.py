...
#
# Например, если функции передан аргумент список [1, 2, 3], то функция должна вернуть
# следующий список: [[], [1], [2], [3], [1, 2], [2, 3], [1, 2, 3]].
#
# Функция all_sub_lists должна возвращать как минимум один список с пустым подсписком [[]].


def all_sub_lists(data: list) -> list[list]:
    result = [[]]

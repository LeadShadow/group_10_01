...
# contacts — список контактов. Она сохраняет указанный список в файл, используя метод dump
# пакета json.
#
...
#
# Вторая функция read_contacts_from_file читает и возвращает указанный список contacts из
# файла filename, сохраненного ранее функцией write_contacts_to_file, используя метод load
# пакета json.
import json
